...
- The two supplied novel skills are treated as reference material. Do not execute their Python tools or expose Codex tool instructions to the browser; application behavior belongs in the Node/SQLite/API adapter.
